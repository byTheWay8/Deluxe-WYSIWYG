...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "K5H9", version: "4.14.1", revision: "eb2d11644", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
            ...
            once: function () { var a = Array.prototype.slice.call(arguments), b = a[1]; a[1] = function (a) { a.removeListener(); return b.apply(this, arguments) }; return this.on.apply(this, a) }, capture: function () { CKEDITOR.event.useCapture = 1; var a = this.on.apply(this, arguments); CKEDITOR.event.useCapture = 0; return a }, fire: function () {
                var a = 0, b = function () { a = 1 }, h = 0, k = function () { h = 1 }; return function (g, l, u) {
                    var e = d(this)[g]; g = a; var x = h; a = h = 0; if (e) {
                        var w = e.listeners; if (w.length) for (var w = w.slice(0), z, G = 0; G < w.length; G++) {
                            if (e.errorProof) try {
                                z =
                                w[G].call(this, u, l, b, k)
                            } catch (t) { } else z = w[G].call(this, u, l, b, k); !1 === z ? h = 1 : "undefined" != typeof z && (l = z); if (a || h) break
                        }
        ...
        function a(a, b) { return -1 < (" " + a + " ").replace(h, " ").indexOf(" " + b + " ") } function d(a) { var b = !0; a.$.id || (a.$.id = "cke_tmp_" + CKEDITOR.tools.getNextNumber(), b = !1); return function () { b || a.removeAttribute("id") } } function b(a, b) { var c = CKEDITOR.tools.escapeCss(a.$.id); return "#" + c + " " + b.split(/,\s*/).join(", #" + c + " ") } function c(a) { for (var b = 0, c = 0, e = k[a].length; c < e; c++)b += parseFloat(this.getComputedStyle(k[a][c]) || 0, 10) || 0; return b } var f = document.createElement("_").classList, f = "undefined" !== typeof f &&
            null !== String(f.add).match(/\[Native code\]/gi), h = /[\n\t\r]/g; CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
                ...
                is: function () { var a = this.getName(); if ("object" == typeof arguments[0]) return !!arguments[0][a]; for (var b = 0; b < arguments.length; b++)if (arguments[b] == a) return !0; return !1 }, isEditable: function (a) {
                    ...
                    CKEDITOR.env.webkit && (w = this.getEditor(!1)) && (w._.previousScrollTop = null); w = a.getWindow(); d = t(this, w); var y = t(a, w), H = this.$.offsetHeight; e = this.$.offsetWidth; var I = a.$.clientHeight, m = a.$.clientWidth; w = d.x - n(this, "left") - y.x || 0; f = d.y - n(this, "top") - y.y || 0; e = d.x + e + n(this, "right") - (y.x + m) || 0; d = d.y + H + n(this, "bottom") - (y.y + I) || 0; (0 > f || 0 < d) && h(0, !0 === b ? f : !1 === b ? d : 0 > f ? f : d); c && (0 > w || 0 < e) && h(0 > w ? w : e, 0)
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, f) {
            function h(a, b, c, e) { var E = c ? a.getPrevious() : a.getNext(); if (e && k) return E; l || e ? b.append(a.clone(!0, f), c) : (a.remove(), u && b.append(a, c)); return E } function n() { var a, b, c, e = Math.min(S.length, p.length); for (a = 0; a < e; a++)if (b = S[a], c = p[a], !b.equals(c)) return a; return a - 1 } function g() {
                ...
                K = a.startOffset, A = a.endOffset, M, r, D, B, v, T; if (l && C.type == CKEDITOR.NODE_TEXT && (m.equals(C) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(C))) c.append(a.document.createText(C.substring(K, A))); else {
                    C.type == CKEDITOR.NODE_TEXT ? l ? T = !0 : C = C.split(A) : 0 < C.getChildCount() ? A >= C.getChildCount() ? (C = C.getChild(A - 1), r = !0) : C = C.getChild(A) : B = r = !0; m.type == CKEDITOR.NODE_TEXT ? l ? v = !0 : m.split(K) : 0 < m.getChildCount() ? 0 === K ? (m = m.getChild(K), M = !0) : m = m.getChild(K - 1) : D = M = !0; for (var S = m.getParents(), p = C.getParents(), N = n(),
                            ...
                            h(A, r) && (l = A.getParent())) : (m = A.getChild(r)) || (l = A); for (; l || m;) {
                                ...
                                CKEDITOR.POSITION_AFTER_START); l.setEnd(this.startContainer, this.startOffset); l = new CKEDITOR.dom.walker(l); var v, T, S = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), p = null, N = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (p) { if (p.equals(a)) { p = null; return } } else p = a; else if (p) return; var b = S(a); b || (v = a); return b }, f = function (a) { var b = N(a); !b && a.is && a.is("br") && (T = a); return b }; l.guard = N; l = l.lastBackward(); v = v || g; this.setStartAt(v,
                                    !v.is("br") && (!l && this.checkStartOfBlock() || l && v.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone(); l = new CKEDITOR.dom.walker(l); var O = CKEDITOR.dom.walker.whitespaces(), q = CKEDITOR.dom.walker.bookmark(); l.evaluator = function (a) { return !O(a) && !q(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break } l = this.clone(); l.collapse(); l.setEndAt(g, CKEDITOR.POSITION_BEFORE_END); l = new CKEDITOR.dom.walker(l); l.guard =
                                        a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : N; v = p = T = null; l = l.lastForward(); v = v || g; this.setEndAt(v, !l && this.checkEndOfBlock() || l && v.contains(l) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); T && this.setEndAfter(T)
                }
        ...
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, f, h) {
            ...
            g = function (a) { return h(a) && k(a) }, l = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, k, w, z, G; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        var L = 0, y = n.hasAscendant("pre"), H = n.type != CKEDITOR.NODE_ELEMENT, I = 0; if (H) n.type == CKEDITOR.NODE_TEXT && f.test(n.getText()) && (H = 0); else {
                            var m = n.getName();
                            if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) { d = n; b(this, a, d); break } else if (n.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { if ("br" == m) H = 1; else if (!k && !n.getChildCount() && "hr" != m) { d = n; w = n.equals(t); break } k && (k.setEndAt(n, CKEDITOR.POSITION_BEFORE_START), "br" != m && (this._.nextNode = n)); L = 1 } else { if (n.getFirst()) { k || (k = this.range.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START)); n = n.getFirst(); continue } H = 1 }
                        } H && !k && (k = this.range.clone(), k.setStartAt(n, CKEDITOR.POSITION_BEFORE_START));
                        w = (!L || H) && n.equals(t); if (k && !L) for (; !n.getNext(g) && !w;) { m = n.getParent(); if (m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { L = 1; H = 0; w || m.equals(t); k.setEndAt(m, CKEDITOR.POSITION_BEFORE_END); break } n = m; H = 1; w = n.equals(t); I = 1 } H && k.setEndAt(n, CKEDITOR.POSITION_AFTER_END); n = this._getNextSourceNode(n, I, t); if ((w = !n) || L && k) break
                    } if (!d) {
    ...
    (function () {
        function a(a, b, c, d, e) {
            var f, m; a = []; for (f in b) {
                m = b[f]; m = "boolean" == typeof m ? {} : "function" == typeof m ? { match: m } : D(m); "$" != f.charAt(0) && (m.elements = f); c && (m.featureName = c.toLowerCase()); var q = m; q.elements = k(q.elements, /\s+/) || null; q.propertiesOnly = q.propertiesOnly || !0 === q.elements; var r = /\s*,\s*/, B = void 0; for (B in T) {
                    q[B] = k(q[B], r) || null; var h = q, p = S[B], n = k(q[S[B]], r), g = q[B], v = [], F = !0, N = void 0; n ? F = !1 : n = {}; for (N in g) "!" == N.charAt(0) && (N = N.slice(1), v.push(N), n[N] = !0, F = !1); for (; N = v.pop();)g[N] =
                        g["!" + N], delete g["!" + N]; h[p] = (F ? !1 : n) || null
                } q.match = q.match || null; d.push(m); a.push(m)
            } b = e.elements; e = e.generic; var C; c = 0; for (d = a.length; c < d; ++c) {
                f = D(a[c]); m = !0 === f.classes || !0 === f.styles || !0 === f.attributes; q = f; B = p = r = void 0; for (r in T) q[r] = L(q[r]); h = !0; for (B in S) { r = S[B]; p = q[r]; n = []; g = void 0; for (g in p) -1 < g.indexOf("*") ? n.push(new RegExp("^" + g.replace(/\*/g, ".*") + "$")) : n.push(g); p = n; p.length && (q[r] = p, h = !1) } q.nothingRequired = h; q.noProperties = !(q.attributes || q.classes || q.styles); if (!0 === f.elements ||
            ...
            } function G(a) { var b = [], c; for (c in a) -1 < c.indexOf("*") && b.push(c.replace(/\*/g, ".*")); return b.length ? new RegExp("^(?:" + b.join("|") + ")$") : null } function t(a) {
            ...
            } function m(a, b, c) { var d, e; for (d = 0; d < c.length; ++d)if (e = c[d], !(e.check && !a.check(e.check, !1) || e.left && !e.left(b))) { e.right(b, F); break } } function C(a, b) {
            ...
            }; var T = { styles: 1, attributes: 1, classes: 1 }, S = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, N = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, O = /^cke:(object|embed|param)$/, q = /^(object|embed|param)$/, F; F = CKEDITOR.filter.transformationsTools = {
            ...
            var h = {}, k = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(h, a); var b = [], e; for (e in a) {
                        var g = a[e], w = g && g.requires; if (!d[e]) { if (g.icons) for (var z = g.icons.split(","), G = z.length; G--;)CKEDITOR.skin.addIcon(z[G], g.path + "icons/" + (CKEDITOR.env.hidpi && g.hidpi ? "hidpi/" : "") + z[G] + ".png"); g.isSupportedEnvironment = g.isSupportedEnvironment || function () { return !0 }; d[e] = 1 } if (w) for (w.split && (w =
    ...
    (function () {
        function a(a, e, f) {
            ...
            function b(a) { if (!a) return ""; CKEDITOR.tools.isArray(a) && (a = a.join(",")); return a.replace(/\s/g, "") } var c = a.config, d = b(c.plugins), e = b(c.extraPlugins), f = b(c.removePlugins); if (e) var h = new RegExp("(?:^|,)(?:" + e.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(h, ""), d = d + ("," + e); if (f) var g = new RegExp("(?:^|,)(?:" + f.replace(/,/g, "|") + ")(?\x3d,|$)", "g"), d = d.replace(g,
                ""); CKEDITOR.env.air && (d += ",adobeair"); CKEDITOR.plugins.load(d.split(","), function (b) {
                    var d = [], e = [], f = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var m in b) {
                        var h = b[m], k = h.lang, C = null, p = h.requires, N; CKEDITOR.tools.isArray(p) && (p = p.join(",")); if (p && (N = p.match(g))) for (; p = N.pop();)CKEDITOR.error("editor-plugin-required", { plugin: p.replace(",", ""), requiredBy: m }); k && !a.lang[m] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? C = a.langCode : (C = a.langCode.replace(/-.*/, ""), C =
                            C != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, C) ? C : 0 <= CKEDITOR.tools.indexOf(k, "en") ? "en" : k[0]), h.langEntries && h.langEntries[C] ? (a.lang[m] = h.langEntries[C], C = null) : f.push(CKEDITOR.getUrl(h.path + "lang/" + C + ".js"))); e.push(C); d.push(h)
        ...
        } a.prototype = CKEDITOR.editor.prototype; CKEDITOR.editor = a; var G = 0, t = {}; CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            plugins: { detectConflict: function (a, b) { for (var c = 0; c < b.length; c++) { var d = b[c]; if (this[d]) return CKEDITOR.warn("editor-plugin-conflict", { plugin: a, replacedWith: d }), !0 } return !1 } }, addCommand: function (a, b) {
                ...
                function a(b) { c.updateElement(); c._.required && !d.getValue() && !1 === c.fire("required") && b.data.preventDefault() } function b(a) { return !!(a && a.call && a.apply) } var c = this, d = c.element, f = new CKEDITOR.dom.element(d.$.form); d.is("textarea") && f && (f.on("submit", a), b(f.$.submit) && (f.$.submit = CKEDITOR.tools.override(f.$.submit, function (b) { return function () { a(); b.apply ? b.apply(this) : b() } })), c.on("destroy", function () {
                    f.removeListener("submit",
                        a)
                }))
            }, destroy: function (a) { var b = CKEDITOR.filter.instances, c = this; this.fire("beforeDestroy"); !a && w.call(this); this.editable(null); this.filter && delete this.filter; CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(b), function (a) { a = b[a]; c === a.editor && a.destroy() }); delete this.activeFilter; this.status = "destroyed"; this.fire("destroy"); this.removeAllListeners(); CKEDITOR.remove(this); CKEDITOR.fire("instanceDestroyed", null, this) }, elementPath: function (a) {
                if (!a) {
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), f = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (h, k, g) {
                function l(a) { var b; if (0 < n.length) for (var c = 0; c < n.length; c++) { var d = n[c], f = d.name, e = CKEDITOR.dtd[f], h = y.name && CKEDITOR.dtd[y.name]; h && !h[f] || a && e && !e[a] && CKEDITOR.dtd[a] ? f == y.name && (x(y, y.parent, 1), c--) : (b || (u(), b = 1), d = d.clone(), d.parent = y, y = d, n.splice(c, 1), c--) } } function u() { for (; L.length;)x(L.shift(), y) } function e(a) {
                ...
                } function x(b, c, d) { c = c || y || t; var f = y; void 0 === b.previous && (w(c, b) && (y = c, G.onTagOpen(g, {}), b.returnPoint = c = y), e(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (I = !1), "textarea" == b.name && (H = !1)); b.returnPoint ? (y = b.returnPoint, delete b.returnPoint) : y = d ? c : f } function w(a, b) {
                ...
                } function z(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 } var G = new CKEDITOR.htmlParser, t = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment, n = [], L = [], y = t, H = "textarea" == t.name, I = "pre" == t.name; G.onTagOpen = function (f, e, h, g) {
                    e = new CKEDITOR.htmlParser.element(f, e); e.isUnknown && h && (e.isEmpty = !0); e.isOptionalClose = g;
                    if (a(e)) n.push(e); else {
                        if ("pre" == f) I = !0; else { if ("br" == f && I) { y.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == f && (H = !0) } if ("br" == f) L.push(e); else {
                            for (; !(g = (h = y.name) ? CKEDITOR.dtd[h] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || y.isUnknown || g[f]);)if (y.isOptionalClose) G.onTagClose(h); else if (f in b && h in b) h = y.children, (h = h[h.length - 1]) && "li" == h.name || x(h = new CKEDITOR.htmlParser.element("li"), y), !e.returnPoint && (e.returnPoint = y), y = h; else if (f in CKEDITOR.dtd.$listItem &&
                                !z(f, h)) G.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (h in d && !z(f, h)) !e.returnPoint && (e.returnPoint = y), y = y.parent; else if (h in CKEDITOR.dtd.$inline && n.unshift(y), y.parent) x(y, y.parent, 1); else { e.isOrphan = 1; break } l(f); u(); e.parent = y; e.isEmpty ? x(e) : y = e
                        }
                    }
                }; G.onTagClose = function (a) {
                    for (var b = n.length - 1; 0 <= b; b--)if (a == n[b].name) { n.splice(b, 1); return } for (var c = [], d = [], f = y; f != t && f.name != a;)f._.isBlockLike || d.unshift(f), c.push(f), f = f.returnPoint || f.parent; if (f != t) {
                        for (b = 0; b < c.length; b++) { var e = c[b]; x(e, e.parent) } y =
                            f; f._.isBlockLike && u(); x(f, f.parent); f == y && (y = y.parent); n = n.concat(d)
                    } "body" == a && (g = !1)
                }; G.onText = function (a) { if (!(y._.hasInlineStarted && !L.length || I || H) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = y.name, e = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!H && !e["#"] && b in d) G.onTagOpen(f[b] || ""), G.onText(a); else { u(); l(); I || H || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (w(y, a)) this.onTagOpen(g, {}, 0, 1); y.add(a) } }; G.onCDATA =
                    function (a) { y.add(new CKEDITOR.htmlParser.cdata(a)) }; G.onComment = function (a) { u(); l(); y.add(new CKEDITOR.htmlParser.comment(a)) }; G.parse(h); for (u(); y != t;)x(y, y.parent, 1); e(t); return t
    ...
    (function () {
        function a(a, d) {
            ...
            } var r = { elements: {} }, g = "html" == d, v = CKEDITOR.tools.extend({}, m), D; for (D in v) "#" in H[D] || delete v[D]; for (D in v) r.elements[D] = p(g, a.config.fillEmptyBlocks); r.root = p(g, !1); r.elements.br = function (a) {
                return function (b) {
        ...
        } function e(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function x(a) { return a.replace(S, function (a, b) { return decodeURIComponent(b) }) } function w(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) { return "\x3c!--" + y + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function z(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function G(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function t(a, b) {
            ...
            f, m = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = f = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(C); c.addRules(K, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); f.addRules(A); f.addRules(M, { applyToAll: !0 }); f.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                a = a.data; var c = a.dataValue, f, c = n(c), c = t(c, b), c = e(c, T), c = u(c), c = e(c, v), c = c.replace(p, "$1cke:$2"), c = c.replace(O, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
            ...
            toHtml: function (a, b, c, d) {
                var f = this.editor, e, p, m, h; b && "object" == typeof b ? (e = b.context, c = b.fixForBody, d = b.dontFilter, p = b.filter, m = b.enterMode, h = b.protectedWhitespaces) : e = b; e || null === e || (e = f.editable().getName()); return f.fire("toHtml", {
                    dataValue: a, context: e, fixForBody: c, dontFilter: d,
                    filter: p || f.filter, enterMode: m || f.enterMode, protectedWhitespaces: h
                }).dataValue
            ...
            }); var r = /<(a|area|img|input|source)\b([^>]*)>/gi, D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, B = /^(href|src|name)$/i, v = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, T = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, S = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, p = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi, N = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, O = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        n = function () {
    ...
    (function () {
        ...
        x = CKEDITOR.dom.walker.whitespaces(!0); w = CKEDITOR.dom.walker.bookmark(!1, !0); z = CKEDITOR.dom.walker.empty(); G = CKEDITOR.dom.walker.bogus(); t = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi; n = function () {
            function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                var e, f, r, g, h = [], k = d.range.startContainer; e = d.range.startPath(); for (var k = B[k.getName()], D = 0, v = c.getChildren(), l = v.count(), n = -1, A = -1, u = 0, T = e.contains(B.$list); D <
                ...
                var F = p.editor, E = !1; "unfiltered_html" == v && (v = "html", E = !0); if (!q.checkReadOnly()) {
                            ...
                            CKEDITOR.POSITION_BEFORE_END); r(E, v.blockLimit, z, y); t && (E.setEndBefore(t), E.collapse(), t.remove()); t = E.startPath(); if (x = t.contains(f, !1, 1)) V = E.splitElement(x), v.inlineStylesRoot = x, v.inlineStylesPeak = t.lastElement; t = E.createBookmark(); J && (l(x), l(V)); (x = t.startNode.getPrevious(c)) && a(x) && f(x) && w.push(x); (x = t.startNode.getNext(c)) && a(x) && f(x) && w.push(x); for (x = t.startNode; (x = x.getParent()) && f(x);)w.push(x); E.moveToBookmark(t); F.enterMode === CKEDITOR.ENTER_DIV && "" === F.getData(!0) && ((F = p.getFirst()) && F.remove(),
                                q.setStartAt(p, CKEDITOR.POSITION_AFTER_START), q.collapse(!0)); if (p = O) {
                                    p = v.range; if ("text" == v.type && v.inlineStylesRoot) { q = v.inlineStylesPeak; F = q.getDocument().createText("{cke-peak}"); for (V = v.inlineStylesRoot.getParent(); !q.equals(V);)F = F.appendTo(q.clone()), q = q.getParent(); O = F.getOuterHtml().split("{cke-peak}").join(O) } q = v.blockLimit.getName(); if (/^\s+|\s+$/.test(O) && "span" in CKEDITOR.dtd[q]) { var H = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; O = H + O + H } O = v.editor.dataProcessor.toHtml(O,
                                        { context: null, fixForBody: !1, protectedWhitespaces: !!H, dontFilter: v.dontFilter, filter: v.editor.activeFilter, enterMode: v.editor.activeEnterMode }); q = p.document.createElement("body"); q.setHtml(O); H && (q.getFirst().remove(), q.getLast().remove()); if ((H = p.startPath().block) && (1 != H.getChildCount() || !H.getBogus())) a: {
                                            var P; if (1 == q.getChildCount() && a(P = q.getFirst()) && P.is(n) && !P.hasAttribute("contenteditable")) {
                                                H = P.getElementsByTag("*"); p = 0; for (V = H.count(); p < V; p++)if (F = H.getItem(p), !F.is(u)) break a; P.moveChildren(P.getParent(1));
                                                P.remove()
                                            }
                                        } v.dataWrapper = q; p = O
                                } if (p) {
                                    P = v.range; p = P.document; q = v.blockLimit; V = 0; var R, H = [], Q, I; O = t = 0; var L, F = P.startContainer; G = v.endPath.elements[0]; var Z, E = G.getPosition(F), w = !!G.getCommonAncestor(F) && E != CKEDITOR.POSITION_IDENTICAL && !(E & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED), F = b(v.dataWrapper, v); for (h(F, P); V < F.length; V++) {
                                        E = F[V]; if (J = E.isLineBreak) J = P, x = q, y = z = void 0, E.hasBlockSibling ? J = 1 : (z = J.startContainer.getAscendant(B.$block, 1)) && z.is({ div: 1, p: 1 }) ? (y = z.getPosition(x), y ==
                                            CKEDITOR.POSITION_IDENTICAL || y == CKEDITOR.POSITION_CONTAINS ? J = 0 : (x = J.splitElement(z), J.moveToPosition(x, CKEDITOR.POSITION_AFTER_START), J = 1)) : J = 0; if (J) O = 0 < V; else {
                                                ...
                                                E.lastNotAllowed && V < F.length - 1 && ((L = w ? G : L) && P.setEndAt(L, CKEDITOR.POSITION_AFTER_START), t = 0); P.collapse()
                                            }
                                    } 1 != F.length ? R = !1 : (R = F[0], R = R.isElement && "false" == R.node.getAttribute("contenteditable")); R && (O = !0, J = F[0].node, P.setStartAt(J, CKEDITOR.POSITION_BEFORE_START), P.setEndAt(J, CKEDITOR.POSITION_AFTER_END)); v.dontMoveCaret = O; v.bogusNeededBlocks = H
                                } R = v.range; var Y; L = v.bogusNeededBlocks; for (Z = R.createBookmark(); Q = v.zombies.pop();)Q.getParent() && (I = R.clone(), I.moveToElementEditStart(Q), I.removeEmptyBlocksAtEnd());
    ...
    (function () {
        ...
        } function w(a, b) { return b ? a.replace(H, function (a, b) { return b ? " " : "" }) : a.replace(y, "") } function z(a, b) {
        ...
        } var n = "function" != typeof window.getSelection, L = 1, y = CKEDITOR.tools.repeat("​", 7), H = new RegExp(y + "( )?", "g"), I, m, C, K = CKEDITOR.dom.walker.invisible(1), A = function () {
            function a(b) {
                return function (a) {
                    var c =
                    ...
                    var b = this.root.editor, c = b && b._.hiddenSelectionContainer; this.reset(); if (c) for (var c = this.root, g, h = 0; h < a.length; ++h)g =
                        a[h], g.endContainer.equals(c) && (g.endOffset = Math.min(g.endOffset, c.getChildCount())); if (a.length) if (this.isLocked) { var k = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); k && !k.equals(this.root) && k.focus() } else {
                            var p; a: {
                                ...
                                if (n) {
                                    l = CKEDITOR.dom.walker.whitespaces(!0); p = /\ufeff|\u00a0/; m = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset)); b = a[0]; a = b.collapsed; var q, F, E; if ((c = b.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in M && (!c.is("a") ||
                                    ...
                                    k = this.getNative(); if (!k) return; this.removeAllRanges(); for (E = 0; E < a.length; E++) {
                                        if (E < a.length - 1 && (q = a[E], F = a[E + 1], p = q.clone(), p.setStart(q.endContainer, q.endOffset), p.setEnd(F.startContainer, F.startOffset), !p.collapsed && (p.shrink(CKEDITOR.NODE_ELEMENT, !0), b = p.getCommonAncestor(), p = p.getEnclosedNode(), b.isReadOnly() || p && p.isReadOnly()))) { F.setStart(q.startContainer, q.startOffset); a.splice(E--, 1); continue } b = a[E]; F = this.document.$.createRange(); b.collapsed &&
                                            CKEDITOR.env.webkit && u(b) && (p = e(this.root), b.insertNode(p), (q = p.getNext()) && !p.getPrevious() && q.type == CKEDITOR.NODE_ELEMENT && "br" == q.getName() ? (x(this.root), b.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(p, CKEDITOR.POSITION_AFTER_END)); F.setStart(b.startContainer.$, b.startOffset); try { F.setEnd(b.endContainer.$, b.endOffset) } catch (t) { if (0 <= t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) b.collapse(1), F.setEnd(b.endContainer.$, b.endOffset); else throw t; } k.addRange(F)
                                    }
                                } this.reset();
    ...
    (function () {
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
                        ...
                        l = !1; if (r.equals(w)) r = null, l = !0; else {
                            var z = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null, v = z && "false" == r.getAttribute("contentEditable"), y = z &&
                                r.getAttribute("data-nostyle"); if (z && r.data("cke-bookmark") || r.type === CKEDITOR.NODE_COMMENT) { r = r.getNextSourceNode(!0); continue } if (v && m && CKEDITOR.dtd.$block[z]) for (var A = r, C = f(A), D = void 0, H = C.length, I = 0, A = H && new CKEDITOR.dom.range(A.getDocument()); I < H; ++I) { var D = C[I], K = CKEDITOR.filter.instances[D.data("cke-filter")]; if (K ? K.check(this) : 1) A.selectNodeContents(D), b.call(this, A) } C = z ? !n[z] || y ? 0 : v && !m ? 0 : d(r, w, h, T) : 1; if (C) if (D = r.getParent(), C = h, H = g, I = k, !D || !(D.getDtd() || CKEDITOR.dtd.span)[H] && !I || C.parentRule &&
                                    !C.parentRule(D)) l = !0; else { if (t || z && CKEDITOR.dtd.$removeEmpty[z] && (r.getPosition(w) | T) != T || (t = c.clone(), t.setStartBefore(r)), z = r.type, z == CKEDITOR.NODE_TEXT || v || z == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) { for (var z = r, M; (l = !z.getNext(B)) && (M = z.getParent(), n[M.getName()]) && d(M, x, h, S);)z = M; t.setEndAfter(z) } } else l = !0; r = r.getNextSourceNode(y || v)
                        } if (l && t && !t.collapsed) {
                            for (var l = L(this, e), v = l.hasAttributes(), y = t.getCommonAncestor(), z = {}, C = {}, D = {}, H = {}, X, W, Y; l && y;) {
                                if (y.getName() == g) {
                                    for (X in h.attributes) !H[X] &&
                                        (Y = y.getAttribute(W)) && (l.getAttribute(X) == Y ? C[X] = 1 : H[X] = 1); for (W in h.styles) !D[W] && (Y = y.getStyle(W)) && (l.getStyle(W) == Y ? z[W] = 1 : D[W] = 1)
                                } y = y.getParent()
                            } for (X in C) l.removeAttribute(X); for (W in z) l.removeStyle(W); v && !l.hasAttributes() && (l = null); l ? (t.extractContents().appendTo(l), t.insertNode(l), G.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), t.extractContents().appendTo(l), t.insertNode(l), G.call(this, l), l.remove(!0)); t = null
                        }
                    } c.moveToBookmark(u);
            ...
            function b() { for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(m.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if (h == a.block || h == a.blockLimit) break; n.checkElementRemovable(h, !0) && (e = h) } for (g = 0; g < c.elements.length; g++) { h = c.elements[g]; if (h == c.block || h == c.blockLimit) break; n.checkElementRemovable(h, !0) && (f = h) } f && m.breakParent(f); e && d.breakParent(e) } a.enlarge(CKEDITOR.ENLARGE_INLINE,
                ...
                } else { var m = c.endNode, n = this; b(); for (f = d; !f.equals(m);)g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? z.call(this, f) : t(f, I(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g } a.moveToBookmark(c); a.shrink(CKEDITOR.NODE_ELEMENT, !0)
        } function f(a) {
            var b =
        ...
        } function G(a) { for (var b = I(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0); for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || t(d, b[f]) } function t(a, b, c) {
            ...
            return a
        } function H(a, b) { for (var c in a) a[c] = a[c].replace(D, function (a, c) { return b[c] }) } function I(a) { if (a._.overrides) return a._.overrides; var b = a._.overrides = {}, c = a._.definition.overrides; if (c) { CKEDITOR.tools.isArray(c) || (c = [c]); for (var d = 0; d < c.length; d++) { var e = c[d], f, g; "string" == typeof e ? f = e.toLowerCase() : (f = e.element ? e.element.toLowerCase() : a.element, g = e.attributes); e = b[f] || (b[f] = {}); if (g) { var e = e.attributes = e.attributes || [], h; for (h in g) e.push([h.toLowerCase(), g[h]]) } } } return b } function m(a,
                    ...
                    apply: function (a) { if (a instanceof CKEDITOR.dom.document) return K.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode; b || (this._.enterMode = a.activeEnterMode); K.call(this, a.getSelection(), 0, a); this._.enterMode = b } }, remove: function (a) {
                        ...
                        b, c) { b && b instanceof CKEDITOR.filter && (c = b); if (c && !c.check(this)) return !1; switch (this.type) { case CKEDITOR.STYLE_OBJECT: return !!a.contains(this.element); case CKEDITOR.STYLE_BLOCK: return !!a.blockLimit.getDtd()[this.element] }return !0 }, checkElementMatch: function (a, b) {
                            var c = this._.definition; if (!a || !c.ignoreReadonly && a.isReadOnly()) return !1; var d = a.getName(); if ("string" == typeof this.element ? d == this.element : d in this.element) {
                                ...
                                } if (c._length) { for (var h in c) if ("_length" != h) if (d = a.getAttribute(h) || "", "style" == h ? C(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0
                            } return !1
...
*/
    ...
    (function () {
        ...
        requires: "panelbutton,floatpanel", init: function (d) {
            function w(a) {
                var u = a.name, f = a.type, h = a.title, v = a.order, t = a.commandName; a = a.contentTransformations || {}; var p = new CKEDITOR.style(k["colorButton_" + f + "Style"]), q = CKEDITOR.tools.getNextId() + "_colorBox", r = { type: f }, l = new CKEDITOR.style(k["colorButton_" + f + "Style"], { color: "inherit" }), n; d.addCommand(t, {
                    contextSensitive: !0, exec: function (a, b) { if (!a.readOnly) { var c = b.newStyle; a.removeStyle(l); a.focus(); c && a.applyStyle(c); a.fire("saveSnapshot") } },
                    refresh: function (a, b) { l.checkApplicable(b, a, a.activeFilter) ? l.checkActive(b, a) ? this.setState(CKEDITOR.TRISTATE_ON) : this.setState(CKEDITOR.TRISTATE_OFF) : this.setState(CKEDITOR.TRISTATE_DISABLED) }
                }); d.ui.add(u, CKEDITOR.UI_PANELBUTTON, {
                    label: h, title: h, command: t, editorFocus: 0, toolbar: "colors," + v, allowedContent: p, requiredContent: p, contentTransformations: a, panel: { css: CKEDITOR.skin.getPath("editor"), attributes: { role: "listbox", "aria-label": g.panelTitle } }, select: function (a) {
                        var b = k.colorButton_colors.split(",");
                        a = CKEDITOR.tools.array.find(b, a); a = m(a); x(n, a); n._.markFirstDisplayed()
                    }, onBlock: function (a, b) { n = b; b.autoSize = !0; b.element.addClass("cke_colorblock"); b.element.setHtml(B({ type: f, colorBoxId: q, colorData: r, commandName: t })); b.element.getDocument().getBody().setStyle("overflow", "hidden"); CKEDITOR.ui.fire("ready", this); var c = b.keys, e = "rtl" == d.lang.dir; c[e ? 37 : 39] = "next"; c[40] = "next"; c[9] = "next"; c[e ? 39 : 37] = "prev"; c[38] = "prev"; c[CKEDITOR.SHIFT + 9] = "prev"; c[32] = "click" }, onOpen: function () {
                        var a = d.getSelection(),
                        b = a && a.getStartElement(), c = d.elementPath(b); if (!c) return null; b = c.block || c.blockLimit || d.document.getBody(); do c = b && b.getComputedStyle("back" == f ? "background-color" : "color") || "transparent"; while ("back" == f && "transparent" == c && b && (b = b.getParent())); c && "transparent" != c || (c = "#ffffff"); !1 !== k.colorButton_enableAutomatic && this._.panel._.iframe.getFrameDocument().getById(q).setStyle("background-color", c); if (b = a && a.getRanges()[0]) {
                            for (var a = new CKEDITOR.dom.walker(b), e = b.collapsed ? b.startContainer : a.next(),
                                b = ""; e;) { e.type !== CKEDITOR.NODE_ELEMENT && (e = e.getParent()); e = m(e.getComputedStyle("back" == f ? "background-color" : "color")); b = b || e; if (b !== e) { b = ""; break } e = a.next() } "transparent" == b && (b = ""); "fore" == f && (r.automaticTextColor = "#" + m(c)); r.selectionColor = b ? "#" + b : ""; x(n, b)
                        } return c
                    }
                })
            } function B(a) {
                function u(a) { a = a && new CKEDITOR.style(n, { color: a }); d.execCommand(t, { newStyle: a }) } var f = a.type, h = a.colorBoxId, v = a.colorData, t = a.commandName; a = []; var p = k.colorButton_colors.split(","), q = k.colorButton_colorsPerRow ||
                ...
                a.push('\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e'); for (h = 0; h < p.length; h++) {
                    0 === h % q && a.push("\x3c/tr\x3e\x3ctr\x3e"); var b = p[h].split("/"), c = b[0], e = b[1] || c; a.push('\x3ctd\x3e\x3ca class\x3d"cke_colorbox" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', b[1] ? c : d.lang.colorbutton.colors[e] || e, '" draggable\x3d"false" ondragstart\x3d"return false;" onclick\x3d"CKEDITOR.tools.callFunction(', m, ",'", e, "','", f, "'); return false;\" href\x3d\"javascript:void('", e, '\')" data-value\x3d"' +
                        e + '" role\x3d"option" aria-posinset\x3d"', h + 2, '" aria-setsize\x3d"', l, '"\x3e\x3cspan class\x3d"cke_colorbox" style\x3d"background-color:#', e, '"\x3e\x3c/span\x3e\x3c/a\x3e\x3c/td\x3e')
                } r && a.push('\x3c/tr\x3e\x3ctr\x3e\x3ctd colspan\x3d"' + q + '" align\x3d"center"\x3e\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"', g.more, '" draggable\x3d"false" ondragstart\x3d"return false;" onclick\x3d"CKEDITOR.tools.callFunction(', m, ",'?','", f, "');return false;\" href\x3d\"javascript:void('",
                    g.more, "')\"", ' role\x3d"option" aria-posinset\x3d"', l, '" aria-setsize\x3d"', l, '"\x3e', g.more, "\x3c/a\x3e\x3c/td\x3e"); a.push("\x3c/tr\x3e\x3c/table\x3e"); return a.join("")
            } function y(a) { return "false" == a.getAttribute("contentEditable") || a.getAttribute("data-nostyle") } function x(a, d) { for (var f = a._.getItems(), h = 0; h < f.count(); h++) { var g = f.getItem(h); g.removeAttribute("aria-selected"); d && d == m(g.getAttribute("data-value")) && g.setAttribute("aria-selected", !0) } } function m(a) {
                return CKEDITOR.tools.normalizeHex("#" +
                    CKEDITOR.tools.convertRgbToHex(a || "")).replace(/#/g, "")
            } var k = d.config, g = d.lang.colorbutton; if (!CKEDITOR.env.hc) {
                w({ name: "TextColor", type: "fore", commandName: "textColor", title: g.textColorTitle, order: 10, contentTransformations: [[{ element: "font", check: "span{color}", left: function (a) { return !!a.attributes.color }, right: function (a) { a.name = "span"; a.attributes.color && (a.styles.color = a.attributes.color); delete a.attributes.color } }]] }); var z, A = d.config.colorButton_normalizeBackground; if (void 0 === A || A) z = [[{
                    element: "span",
                    left: function (a) { var d = CKEDITOR.tools; if ("span" != a.name || !a.styles || !a.styles.background) return !1; a = d.style.parse.background(a.styles.background); return a.color && 1 === d.object.keys(a).length }, right: function (a) { var g = (new CKEDITOR.style(d.config.colorButton_backStyle, { color: a.styles.background })).getDefinition(); a.name = g.element; a.styles = g.styles; a.attributes = g.attributes || {}; return a }
                }]]; w({ name: "BGColor", type: "back", commandName: "bgColor", title: g.bgColorTitle, order: 20, contentTransformations: z })
            }
        }
    });
    CKEDITOR.config.colorButton_colors = "1ABC9C,2ECC71,3498DB,9B59B6,4E5F70,F1C40F,16A085,27AE60,2980B9,8E44AD,2C3E50,F39C12,E67E22,E74C3C,ECF0F1,95A5A6,DDD,FFF,D35400,C0392B,BDC3C7,7F8C8D,999,000"; CKEDITOR.config.colorButton_foreStyle = { element: "span", styles: { color: "#(color)" }, overrides: [{ element: "font", attributes: { color: null } }] }; CKEDITOR.config.colorButton_backStyle = { element: "span", styles: { "background-color": "#(color)" } }; CKEDITOR.plugins.add("dialogui", {
        onLoad: function () {
    ...
    (function () {
    ...
    })(); var stylesLoaded = !1; CKEDITOR.plugins.add("dialog", { requires: "dialogui", init: function (z) { stylesLoaded || (CKEDITOR.document.appendStyleSheet(this.path + "styles/dialog.css"), stylesLoaded = !0); z.on("doubleclick", function (A) { A.data.dialog && z.openDialog(A.data.dialog) }, null, null, 999) } }); CKEDITOR.plugins.colordialog = {
        requires: "dialog", init: function (b) {
            var d = new CKEDITOR.dialogCommand("colordialog"); d.editorFocus = !1; b.addCommand("colordialog", d); CKEDITOR.dialog.add("colordialog", this.path + "dialogs/colordialog.js"); b.getColorFromDialog = function (d, k, g) {
                var c, e, h, f; c = function (a) { h(this); a = "ok" == a.name ? this.getValueOf("picker", "selectedColor") : null; /^[0-9a-f]{3}([0-9a-f]{3})?$/i.test(a) && (a = "#" + a); d.call(k, a) }; e = function (a) { g && (a.data = g) }; h = function (a) {
                    a.removeListener("ok", c); a.removeListener("cancel",
                        c); a.removeListener("show", e)
                }; f = function (a) { a.on("ok", c); a.on("cancel", c); a.on("show", e, null, null, 5) }; b.execCommand("colordialog"); if (b._.storedDialogs && b._.storedDialogs.colordialog) f(b._.storedDialogs.colordialog); else CKEDITOR.on("dialogDefinition", function (a) { if ("colordialog" == a.data.name) { var b = a.data.definition; a.removeListener(); b.onLoad = CKEDITOR.tools.override(b.onLoad, function (a) { return function () { f(this); b.onLoad = a; "function" == typeof a && a.call(this) } }) } })
            }
        }
    };
    ...
    CKEDITOR.config.smiley_descriptions = "smiley;sad;wink;laugh;frown;cheeky;blush;surprise;indecision;angry;angel;cool;devil;crying;enlightened;no;yes;heart;broken heart;kiss;mail".split(";"); CKEDITOR.plugins.add("specialchar", {
